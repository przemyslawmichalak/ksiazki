...
object Application extends Controller { 
  ...
  val computerForm = Form(
    mapping(
      ...
      "tytul" -> nonEmptyText,
      "autor" -> nonEmptyText,
      "data" -> optional(date("yyyy-MM-dd")),
      "opinia" -> nonEmptyText,
      "ocena" -> optional(number) ,
      "stron" -> optional(number)
  ...
  def update(id: Long) = Action { implicit request =>
    computerForm.bindFromRequest.fold(
      ...
      computer => {
        ...
        Home.flashing("success" -> "Ksiazka %s zaktualizowana".format(computer.tytul))
      }
    )
  }
  ...
  def save = Action { implicit request =>
    computerForm.bindFromRequest.fold(
      ...
      computer => {
        ...
        Home.flashing("success" -> "Ksiazka %s zostala stworzona".format(computer.tytul))
      }
    )
  }
  ...
  def delete(id: Long) = Action {
    Computer.delete(id)
    Home.flashing("success" -> "Ksiazka usunieta")
  }
